...
namespace ZakaZaka.Service.FileOnServer
{
    public sealed class FileOnServer : IFileOnServer
    {
        ...
        private void ValidateAdd(IFormFile file, string pathToFolder)
        {
            if (file == null)
        ...
        private void ValidateRemove(string pathToFile)
        {
